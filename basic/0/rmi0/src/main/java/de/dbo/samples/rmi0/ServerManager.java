...
public class ServerManager {
    ...
    /**
     * start-up of the default RMI-server
    ...
    public static final boolean openServer(final String name) 
	    throws RemoteException {
	return openServer(name, 1099);
    }

    public static final boolean closeServer(final String name) 
    ...
    public static final boolean closeServers() 
	    throws RemoteException, NotBoundException {
	return closeServers(1099);
    }

    public static final boolean closeServers(int port) 
	    throws RemoteException, NotBoundException {
	...
	try {
	    ...
	    throw new ServerManagerException("Unexpected error while getting RMI-registry at port " + port, e);
	}  
    ...
    public static final boolean isInRegistery(final Registry registry, final String name) 
	    throws AccessException, RemoteException {
	return null != registry.list() && Arrays.asList(registry.list()).contains(name);
    }

    public static final String print(final Registry registry) 
	    throws AccessException, RemoteException {
