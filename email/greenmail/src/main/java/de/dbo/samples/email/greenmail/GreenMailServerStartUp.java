 ...
 */
public class GreenMailServerStartUp {
    private final Logger log = LoggerFactory.getLogger(GreenMailServerStartUp.class);
    
    public void doRun(GreenMailServerSetUp greenMailServerSetUp, long timeout) throws Throwable{
//	GreenMail greenMail = greenMailServerSetUp.getServer();
        log.info("Starting GreenMail standalone using: " + greenMailServerSetUp);
	greenMailServerSetUp.start(timeout);
    }
...
//        if (null == log4jConfig) {
//            DOMConfigurator.configure(GreenMailServerStartUp.class.getResource("/log4j.xml"));
//        } else {
...
//        }
//
//        new GreenMailServerStartUp().doRun(System.getProperties());
//    }
}
