...
package de.dbo.samples.image.houghtransform.filter;
 ...
 */
public final class MandatoryPointBasedThresholdFilter extends PointFilter {
     ...
     */
    public MandatoryPointBasedThresholdFilter() {
        this(220);
    }
     ...
     */
    public MandatoryPointBasedThresholdFilter(int t) {
        setLowerThreshold(t);
        setUpperThreshold(t);
    }
    ...
    public HashMap<String, Object> getProperties() {
        ...
        properties.put("threshold", (float) this.getLowerThreshold());
        return properties;
    }
    ...
    public void setProperties(HashMap<String, Object> properties) {
        ...
        if (properties != null && !properties.isEmpty()) {
            float tempThreshold = (Float) properties.get("threshold");
            int threshold = (int) tempThreshold;
