 ...
 *
 */
public class XTreetableCell extends JTree implements TableCellRenderer {
	private static final long serialVersionUID = 7501441646955414246L;
	private static final Logger log = LoggerFactory.getLogger(XTreetableCell.class);
	...
	public XTreetableCell(Treetable treeTable, TreeModel model) {
        super(model);
